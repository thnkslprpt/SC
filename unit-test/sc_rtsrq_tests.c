...
void ContinueRtsOnFailureCmd_Test_Nominal(void)
{
    ...
    /* Verify results */
    UtAssert_BOOL_TRUE(SC_OperData.HkPacket.Payload.ContinueRtsOnFailureFlag);
    UtAssert_True(SC_OperData.HkPacket.Payload.CmdCtr == 1, "SC_OperData.HkPacket.Payload.CmdCtr == 1");
...
void ContinueRtsOnFailureCmd_Test_FalseState(void)
{
    ...
    /* Verify results */
    UtAssert_True(SC_OperData.HkPacket.Payload.ContinueRtsOnFailureFlag == false,
                  "SC_OperData.HkPacket.Payload.ContinueRtsOnFailureFlag == false");
    UtAssert_True(SC_OperData.HkPacket.Payload.CmdCtr == 1, "SC_OperData.HkPacket.Payload.CmdCtr == 1");
